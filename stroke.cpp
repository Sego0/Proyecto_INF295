...
std::vector<Stroke> randomInit(const Canvas& target, int maxStrokes) {
    std::cout << "[Random] Generando solución inicial con control espacial...\n";
    ...
    std::cout << "[Random] Error final: " << prevError << "\n";
    std::cout << "[Random] Finalizado con " << strokes.size() << " strokes.\n";
    return strokes;
}
